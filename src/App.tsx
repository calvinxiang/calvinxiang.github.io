    ...
    <div className={`info-panel ${isVisible ? 'visible' : 'hidden'}`}>
      ...
      <div className="info-content">
        ...
        <p className="bio">
          ...
          I'm looking for a software engineering internship for Summer 2025. As you can see I also like to play hockey.
        </p>
...
function Player() {
  ...
  useFrame((state, delta) => {
    ...
    if (keysPressed.size > 0 || (joystickInput.x !== 0 || joystickInput.y !== 0)) {
      ...
      flipperAngle.current = THREE.MathUtils.lerp(flipperAngle.current, 0, delta * 2)
      waddleAngle.current = THREE.MathUtils.lerp(waddleAngle.current, 0, delta * 2)
    }
